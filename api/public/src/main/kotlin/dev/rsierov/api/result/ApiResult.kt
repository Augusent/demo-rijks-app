...
package dev.rsierov.api.result

import dev.rsierov.api.ApiCallException
import dev.rsierov.api.cause
import dev.rsierov.api.result.ApiResult.Failure
import dev.rsierov.api.result.ApiResult.Success
