...
internal class RequestExecutor constructor(
    private val config: Config,
    stringFormat: StringFormat,
    coroutineDispatcher: RequestCoroutineDispatcher,
) {
...
internal class RequestContext internal constructor(
    ...
    /**
     * Hacky way to enforce cache refresh, see [disclaimer][dev.rsierov.api.rijks.ClientDrivenCacheControl]
     */
